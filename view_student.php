...
<div class="one card" style="width: 20rem;">
  <img src="./image/<?php echo $row['photo'];?>" class="card-img-top" height="250px" alt="invalid">
  <div class="card-body">
    <strong>Name:</strong>
    ...
    <strong>Grade:</strong>
    <h5 class="card-title"><?php echo $row['grade'];?></h5>
    <a href="remove_student.php?id=<?php echo $row['s_id'];?>" class="btn btn-danger">Delete</a>
