...
if(isset($_POST['submit'])){
  ...
  if($email=="teachers@gmail.com" && $password=="123"){
    // $value=$_SESSION['']
    echo'<script>alert("welcome back teacher");window.location.href="teacher_home.php"</script>';
  }else{
    echo'<script>alert("you are no longer as teacher");window.location.href="#"</script>';
  }
}
?>
